...
use Simple\SimpleRouter\Handlers\IEventHandler;
use Simple\SimpleRouter\Route\IGroupRoute;
use Simple\SimpleRouter\Route\ILoadableRoute;
use Simple\SimpleRouter\Route\IPartialGroupRoute;
use Simple\SimpleRouter\Route\IRoute;
use Simple\SimpleRouter\Route\RouteController;
use Simple\SimpleRouter\Route\RouteGroup;
use Simple\SimpleRouter\Route\RoutePartialGroup;
use Simple\SimpleRouter\Route\RouteResource;
use Simple\SimpleRouter\Route\RouteUrl;
...
class SimpleRouter
{
     ...
     * Start routing
     *
     * @throws \Simple\SimpleRouter\Exceptions\NotFoundHttpException
     * @throws \Simple\Http\Middleware\Exceptions\TokenMismatchException
        ...
        if (is_file($composerFile) === true) {
            ...
            if (isset($composerInfo['packages']) === true && is_array($composerInfo['packages']) === true) {
                foreach ($composerInfo['packages'] as $package) {
                    if (isset($package['name']) === true && strtolower($package['name']) === 'Simple/simple-router') {
