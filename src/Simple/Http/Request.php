...
use Simple\Http\Trait\InputHandler;
use Simple\SimpleRouter\Route\ILoadableRoute;
use Simple\SimpleRouter\Route\RouteUrl;
use Simple\SimpleRouter\SimpleRouter;
use ArrayAccess;
use IteratorAggregate;
use Simple\Http\Trait\InputFile;
use Simple\Http\Trait\InputItem;

class Request implements ArrayAccess, IteratorAggregate
{
    use InputHandler, InputItem, InputFile;
